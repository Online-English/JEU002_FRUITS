...
function updateLevelLockUI() {
    const playerLevel = getUserPlayerLevel(); // Calculé dynamiquement par script.js
...
function renderDict(data = null) {
    ...
    if(data.length === 0) {
        container.innerHTML = `<p class="text-center text-sm py-4 text-gray-400">Aucun fruit trouvé dans ce niveau.</p>`;
        return;
    }
